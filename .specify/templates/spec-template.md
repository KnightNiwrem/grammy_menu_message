...
- **Response Time**: [e.g., "Menu rendering must complete within 100ms"]
- **Throughput**: [e.g., "Must handle 1000 menu interactions/minute"]
- **Memory**: [e.g., "Must not exceed 50MB per bot instance"]
- **Telegram Limits**: [e.g., "Must respect 30 messages/second rate limit"]
...
- **Testing**: Minimum 90% code coverage for public APIs
...
- [ ] Quality standards referenced from constitution
